...
class PVICareEnterprise extends Component {
  constructor(props) {
    super(props);
...
export default connect(mapStateToProps, { landingPageMobileMenuToggle, landingPageMobileMenuClose })(injectIntl(PVICareEnterprise))
